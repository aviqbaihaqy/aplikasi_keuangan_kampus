...
<head>
  ...
  <title>Buku Pembantu Hutang</title>
  <!-- Icons-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="icon-layers"></i><b>Buku Pembantu Hutang</b>
                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal">
										 <span class="h3"><a class="icon-magnifier"></a> Pencarian</span>
                                        <div class="row">
                                       ...
                                       <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput">Nama Suplier</label>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <select id="select1" name="select1" class="form-control">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-actions col-md-8">
                                                <button type="submit" class="btn btn-primary">Tampilkan <i class="icon-arrow-right"></i><i class="icon-arrow-right"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-10">
                                            ...
                                            <li class="page-item">
                                                <a class="page-link"> 1-1 dari 1 </a>
                                            </li>
                                            <li class="page-item">
                                         ...
                                         <button type="submit">Print</button><button type="submit">Excel</button><button type="submit">Aging</button>
                                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                        <thead align="center">
                                            <tr bgcolor="#20A8D8">
                                                <th>NO</th>
                                                <th>NAMA SUPLIER</th>
												<th>TOTAL TRANSAKSI HUTANG(RP)</th>
                                                <th>SUDAH DIBAYAR(RP)</th>
                                                <th>SISA HUTANG(RP)</th>
												<th><center>AKSI</center></th>
                                            </tr>
                                        </thead>
                                        <tbody align="center" bgcolor="#D2D2D2">
                                            <tr>
                                                <td>1</td>
                                                <td>Pakoe Boemi</td>
                                                <td>1.000.000,00</td>
