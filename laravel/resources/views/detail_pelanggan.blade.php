...
<body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
  ...
  <div class="app-body">
          ...
          <div class="row">
            <div class="col-lg-12">
			  ...
			  <div class="card-header">
				<button type="submit" class="btn btn-secondary float-right"> <i class="fa fa-level-up"></i></button>
				<button type="submit" class="btn btn-secondary float-right"> <i class="fa fa-edit"></i></button>
			</div>
                <div class="card-header">
                  Pelanggan
                </div>
    ...
    <label class="col-form-label" for="no_lpb">Kode Pelanggan </label>
    </div>
    ...
    <div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">Nama Pelanggan </label>
    </div>
    <div class="form-group col-md-6">
    <label>Wahyono</label>
    </div>
    ...
    <div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">Alamat Cabang </label>
    </div>
    <div class="form-group col-md-6">
    <label>Jakarta</label>
    </div>
    ...
    <div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">No Telepon </label>
    </div>
    <div class="form-group col-md-6">
    <label>08561061504</label>
    </div>
    </div>  	
    ...
    <div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">No Fax </label>
    </div>
    <div class="form-group col-md-6">
    <label>02749364966</label>
    </div>
    </div>

	<div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">Tipe Pelanggan </label>
    </div>
    <div class="form-group col-md-6">
	...
	<div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">Kontak </label>
    </div>
    <div class="form-group col-md-6">
    <label> </label>
    </div>
	...
	<div class="row">
    <div class="form-group col-md-4">
    <label class="col-form-label" for="no_lpb">Telepon Kontak </label>
    </div>
    <div class="form-group col-md-6">
    <label> </label>
    </div>
