                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput">Kode Pelanggan</label>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput"><input type="text" name="kode"></label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput">Nama Pelanggan</label>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput"><input type="text" name="nama"></label>
                                            </div>
                                        </div>
                                            
                                          <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput">Alamat Pelanggan</label>
                                            </div>
                                            <div class="form-group col-md-4">                           
                                              <label class="col-form-label" for="prependedInput"><input type="text" name="alamat">
                                                </label>
                                            </div>
                                        </div>
                                        <div>                                     
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <nav class="float-left">
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link" href="#"><i class="fa fa-fast-backward"></i></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="#"><i class="fa fa-backward"></i></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="#"> 1-3 dari 3 </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="#"><i class="fa fa-forward"></i></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="#"><i class="fa fa-fast-forward"></i></a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <button type="submit" class="btn btn-secondary float-right">Tambah <i class="fa fa-plus"></i></button>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Konfirmasi Hapus Data Pemabayaran Hutang</h5>
                    </div>
                    <div class="modal-body">
                        <h6 class="modal-title"></h6>
                            <p>Anda akan menghapus List Pemabayaran Hutang Dengan Kode :<br>
                                ????????????<br>
                                Apakah Anda yakin ?</p>
                    </div>
