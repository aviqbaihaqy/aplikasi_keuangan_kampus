...
<html lang="en">
    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
        <header class="app-header navbar">
            ...
            <a class="navbar-brand" href="{{ URL::to('path') }}">
            ...
            <ul class="nav navbar-nav d-md-down-none">
                <li class="nav-item px-3">
                    <a class="nav-link" href="{{ URL::to('path') }}">Dashboard</a>
                </li>
                <li class="nav-item px-3">
                    <a class="nav-link" href="{{ URL::to('path') }}">Users</a>
                </li>
                <li class="nav-item px-3">
                    <a class="nav-link" href="{{ URL::to('path') }}">Settings</a>
                </li>
            </ul>
            <ul class="nav navbar-nav ml-auto">
                <li class="nav-item d-md-down-none">
                    <a class="nav-link" href="{{ URL::to('path') }}">
                        <i class="icon-bell"></i>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" data-toggle="dropdown" href="{{ URL::to('path') }}" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item" href="{{ URL::to('path') }}">
        ...
        <div class="app-body">
                ...
                <nav class="sidebar-nav">
                    <ul class="nav">
                        ...
                        <li class="nav-item nav-dropdown">
                            <a class="nav-link nav-dropdown-toggle" href="{{ URL::to('path') }}">
            ...
            <main class="main">
                <!-- Breadcrumb-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">/List Tagihan Piutang</li>
                    <!-- Breadcrumb Menu-->
                    <!-- <li class="breadcrumb-menu d-md-down-none">
                        <div class="btn-group" role="group" aria-label="Button group">
                            <a class="btn" href="{{ URL::to('path') }}">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> List Tagihan Piutang
                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal">
                                        <span class="h3">Pencarian</span>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput">Unit Kerja</label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput">Periode</label>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label" for="prependedInput"></label>
                                            </div>
                                            <div class="form-group col-md-8">
                                                <label class="col-form-label" for="prependedInput">s.d.</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-actions col-md-8">
                                                <button type="submit" class="btn btn-primary">Tampilkan <i class="fa fa-forward"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <nav class="float-left">
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link" href="{{ URL::to('path') }}"><i class="fa fa-fast-backward"></i></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="{{ URL::to('path') }}"><i class="fa fa-backward"></i></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="{{ URL::to('path') }}"> 1-1 dari 1 </a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="{{ URL::to('path') }}"><i class="fa fa-forward"></i></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="{{ URL::to('path') }}"><i class="fa fa-fast-forward"></i></a>
                                            </li>
                                        </ul>
                                    </nav>
                                    <button type="submit" class="btn btn-secondary float-right">Kembali <i class="fa fa-level-up"></i></button>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <button type="button" class="btn btn-secondary fa fa-print"></button>
                                                    </div>
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <button type="button" class="btn btn-danger fa fa-trash" data-toggle="modal" data-target="#deleteModal"></button>
                                                    </div>
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <button type="button" class="btn btn-secondary fa fa-edit"></button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
            ...
            <div class="modal-dialog modal-danger" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Transaksi Tagihan Piutang</h5>
                    </div>
                    <div class="modal-body">
                        <h6 class="modal-title">Konfirmasi Hapus Transaksi Tagihan Piutang</h6>
                        <h6>Menghapus Transaksi Tagihan Piutang</h5>
                            <p>Anda akan menghapus Transaksi Piutang dengan nama / kode:<br>
                                ????????????<br>
                                Apakah Anda yakin ?</p>
                    </div>
