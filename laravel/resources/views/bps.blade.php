    ...
    <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
        ...
        <div class="app-body">
            ...
            <main class="main">
                <!-- Breadcrumb-->
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Buku Pembantu Stok</li>
                    <!-- Breadcrumb Menu-->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <i class="fa fa-align-justify"></i> Buku Pembantu Stok
                                </div>
                                <div class="card-body">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <label class="col-form-label Bagian" for="prependedInput">Nama Barang</label>
                                            <br> <label class="col-form-label Barang" for="prependedInput">Bagian/Unit Kerja</label></div>
                                            <div class="form-group col-md-6">
                                                <input class="form-control" type="text" name="cari"/><select id="select1" name="select1" class="form-control"><br>
                                                    <option value="0">--SEMUA UNIT--</option>
                                                </select>
												<br>
                                            <div class="form-actions col-md-8">
                                                <button type="submit" class="btn btn-primary">Tampilkan >></button></div>
                                        </div>
                                        </div>
                                        </div>
                                    </form>
                                    ...
                                    <div class="row">
                                        <div class="col-md-10">
                                            <nav>
                                                <ul class="pagination">
                                                    ...
                                                    <li class="page-item">
                                                        <a class="page-link" href="#"> 1-2 dari 2 </a>
                                                    </li>
                                                    <li class="page-item">
                                                        <a class="page-link" href="#"> > </a>
                                                    </li>
                                        ...
                                        <div class="col-md-2">
                                            <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                    ...
                                                    <div class="btn-group mr-2" role="group" aria-label="Second group">
                                                        <button type="button" class="btn btn-success fa fa-file-excel-o"></button>
                                                    </div>
                                        </div>
                                    </div>
